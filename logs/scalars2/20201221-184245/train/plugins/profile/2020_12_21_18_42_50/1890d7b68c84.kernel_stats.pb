...
å
‡void cudnn::detail::bn_bw_1C11_kernel_new<float, float, float2, 512, true, 1>(float, float, float, float, cudnnTensorStruct, float const*, cudnnTensorStruct, float const*, cudnnTensorStruct, float*, float const*, float*, float*, float const*, float const*, float)*28â3@â3Hâ3bAgradient_tape/alex_net/batch_normalization_1/FusedBatchNormGradV3h
¶
...
İ
ƒvoid cudnn::winograd_nonfused::winogradForwardData9x9_5x5<float, float>(cudnn::winograd_nonfused::WinogradDataParams<float, float>)*28ä1@ä1Hä1Xb;gradient_tape/alex_net/conv2d_1/Conv2D/Conv2DBackpropFilterh
‡
